...
void KnapsackGUI::solveKnapsack()
{
...
void KnapsackGUI::renderResults()
{
    ImGui::Separator();
    ImGui::Text("Results");
...
void KnapsackGUI::renderVisualRepresentation(const SolverResult& result)
{
